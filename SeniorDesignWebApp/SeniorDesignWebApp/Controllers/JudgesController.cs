...
namespace SeniorDesignWebApp.Controllers
{
    public class JudgesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "JudgeId,Name,Race,Gender,Tenure,AppointedBy")] judge judge)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "JudgeId,Name,Race,Gender,Tenure,AppointedBy")] judge judge)
        {
            if (ModelState.IsValid)
            {
