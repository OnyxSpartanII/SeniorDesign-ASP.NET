...
namespace SeniorDesignWebApp.Controllers
{
    public class OrganizedCrimeGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OCGId,Name,Size,Scope")] organizedcrimegroup organizedcrimegroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OCGId,Name,Size,Scope")] organizedcrimegroup organizedcrimegroup)
        {
            if (ModelState.IsValid)
            {
